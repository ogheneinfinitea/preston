    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-md-8 contact-form">
                ...
                <!-- Contact Form Starts -->
                <form class="form-contact" method="post" action="http://www.slimhamdi.net/bayya/php/process-form.php">
                    <!-- Input Field Starts -->
                ...
                <div class="widget">
                    <div class="contact-page-info">
                        ...
                        <div class="contact-info-box">
                            ...
                            <div class="contact-info-box-content">
                                <h4>Phone Numbers</h4>
                                <p>Whatsapp No. +44 7551 104014</p>
                            </div>
                        </div>
                        <!-- Contact Info Box Ends -->
                        <!-- Contact Info Box Starts -->
                        <div class="contact-info-box">
                            ...
                            <div class="contact-info-box-content">
                                ...
                                <p>support@prestonmanager.live.com</p>
                            </div>
                        </div>
                        <!-- Contact Info Box Ends -->
